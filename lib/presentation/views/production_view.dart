...
class _ProductionViewState extends State<ProductionView> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        title: TextField(
          decoration: const InputDecoration(hintText: 'Buscar por orden de trabajo'),
              ...
              : ListView.builder(
                  ...
                  itemBuilder: (BuildContext context, int index) {
                    ...
                    return Accordion(
                      ...
                      rightIcon: const Icon(Icons.keyboard_arrow_down_rounded, size: 33, color: Colors.black,),
                      headerPadding:
